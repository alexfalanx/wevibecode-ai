...
export default function GeneratePage() {
  ...
  const calculateTotalCredits = () => {
    const baseCredits = 1;
    const imageCredits = includeImages ? 4 : 0; // Flat fee for curated real photos
            ...
            {includeImages ? (
              <div className="space-y-2">
                <p className="text-sm text-gray-700">
                  ✨ <strong>Professional real photos</strong> from Unsplash will be curated for your website
                </p>
                <p className="text-sm text-gray-600">
                  Real, high-quality photography perfectly matched to your content!
                </p>
                <p className="text-xs text-gray-500 mt-2">
                  Cost: +4 credits (flat fee for curated professional photos)
                </p>
              </div>
            ) : (
              <p className="text-sm text-gray-600">
                Website will use colored blocks or gradients as placeholders
              </p>
            )}
          </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="text-sm text-gray-600">
                  {includeImages ? (
                    <>1 credit (website) + 4 credits (curated real photos)</>
                  ) : (
