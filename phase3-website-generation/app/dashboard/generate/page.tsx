...
const WEBSITE_TYPES = [
  { value: 'landing', label: 'Landing Page', description: 'Perfect for products, services, or campaigns' },
  { value: 'portfolio', label: 'Portfolio', description: 'Showcase your work and skills' },
  { value: 'business', label: 'Business', description: 'Professional company website' },
  { value: 'restaurant', label: 'Restaurant', description: 'Menu, location, and reservations' },
  { value: 'blog', label: 'Blog', description: 'Content and articles' },
  { value: 'ecommerce', label: 'E-commerce', description: 'Product showcase and sales' },
];
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8 mb-8">
          ...
          <div className="mb-8">
            ...
            <textarea
              ...
              placeholder="Example: A modern landing page for a fitness app with a hero section, features grid, and pricing plans. Focus on health and motivation."
        ...
        <div className="bg-white rounded-3xl shadow-lg p-6">
          ...
          <div className="space-y-2 text-sm text-gray-700">
            <div className="p-3 bg-gray-50 rounded-lg">
              "A landing page for a SaaS project management tool with hero, features, pricing, and testimonials"
            </div>
            <div className="p-3 bg-gray-50 rounded-lg">
              "A restaurant website for an Italian bistro with menu, location, hours, and reservation form"
            </div>
            <div className="p-3 bg-gray-50 rounded-lg">
              "A portfolio for a freelance graphic designer showcasing 6 projects with smooth animations"
            </div>
          </div>
        </div>
      </div>
