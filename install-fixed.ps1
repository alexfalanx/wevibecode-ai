# Install Preview Page - Bracket-Safe Version
Write-Host "Installing Preview Page..." -ForegroundColor Cyan

# Use literal path to avoid wildcard issues
$dir = "app\dashboard\preview\``[id``]"
...
$file = "$dir\page.tsx"
$code | Out-File -LiteralPath $file -Encoding UTF8 -Force
...
if (Test-Path -LiteralPath $file) {
    ...
    Write-Host ""
    Write-Host "Success! Now run: npm run build" -ForegroundColor Yellow
} else {
